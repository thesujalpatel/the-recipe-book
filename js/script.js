const recipes = [
  {
    ...
    prepTime: "under-30",
    description:
      "Rich and creamy curry made with paneer, butter, and tomato gravy.",
    ingredients:
      "Paneer, butter, tomatoes, cream, onions, garlic, ginger, garam masala",
    image:
  ...
  },
  {
    ...
    prepTime: "over-60",
    description:
      "Crispy rice crepe stuffed with spiced potato filling, served with chutney and sambar.",
    ingredients:
      "Rice, urad dal, potatoes, curry leaves, green chilies, mustard seeds",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1gPSMIK3sUiRUDNve5tgZh2FrCEAgpxb-tw&s",
    steps: [
  ...
  },
  {
    ...
    ingredients:
      "Chickpeas, flour, onions, tomatoes, ginger, garlic, garam masala",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8qZYqLr9OgwtfLJkC1ETQUn4oS__y5tjYBQ&s",
    steps: [
  ...
  },
  {
    ...
    prepTime: "under-30",
    description:
      "Steamed rice cakes served with spicy lentil stew and coconut chutney.",
    ingredients: "Rice, urad dal, toor dal, tamarind, curry leaves, coconut",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGR_wP79RQXv1rShNTWgPHDtxnqnRfboBLdQ&s",
    steps: [
  ...
  },
  {
    ...
    prepTime: "over-60",
    description:
      "Stuffed whole wheat bread with spiced potato filling, served with butter or yogurt.",
    ingredients: "Wheat flour, potatoes, green chilies, onions, butter",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxueufrBj0wynq0knzDYAqTIfVMo7-uk-icg&s",
    steps: [
  ...
  },
  {
    ...
    image:
      "https://bhojmasale.com/cdn/shop/articles/delicious-pav-bhaji-recipe-a-step-by-step-guide-930907_1024x1024.webp?v=1739152900",
    steps: [
  ...
  },
  {
    ...
    prepTime: "30-60",
    description:
      "Yellow lentils cooked and tempered with ghee, garlic, and red chilies.",
  ...
  },
  {
    ...
    prepTime: "over-60",
    description:
      "Crispy puris filled with spicy tangy water and potato stuffing.",
    ingredients: "Sooji, potatoes, tamarind, mint, green chilies, chickpeas",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTorqQfvieS0ikzzKGuxNL9kkj52CTGVtA0CA&s",
    steps: [
  ...
  },
  {
    ...
    ingredients:
      "Basmati rice, carrots, beans, peas, onions, bay leaves, cloves",
    image:
  ...
  },
  {
    ...
    prepTime: "over-60",
    description:
      "Steamed savory cake made with gram flour, popular in Gujarat.",
    ingredients:
      "Gram flour, yogurt, lemon juice, green chili, mustard seeds, curry leaves",
    image:
  ...
  },
  {
    ...
    prepTime: "under-30",
    description:
      "Mumbai’s famous street food made with spicy potato fritter in bread bun.",
    ingredients:
      "Potatoes, gram flour, pav bread, garlic chutney, green chilies",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQo4Bg-PSNOU142m2TooCDwaXqYrCJsV5vHnQ&s",
    steps: [
...

  {
    ...
    prepTime: "30-60",
    description:
      "Spiced chickpea curry cooked with onions, tomatoes, and Indian spices.",
    ingredients: "Chickpeas, onions, tomatoes, garlic, ginger, garam masala",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQl949jrdLZseI1fRYRqcoOiKw-RR8xMmNRNw&s",
    steps: [
      "Soak and boil chickpeas.",
  ...
  },
  {
    ...
    prepTime: "over-60",
    description:
      "Yellow lentils cooked with turmeric and tempered with oil, garlic, and chilies.",
    ingredients: "Toor dal, onions, tomatoes, garlic, cumin, chili powder, oil",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVMGvL1fKs_FIa6SSdCictZQ1YnLRGEcsQYg&s",
    steps: [
  ...
  },
  {
    ...
    prepTime: "under-30",
    description:
      "Healthy grain bowl with quinoa, roasted veggies, avocado, and tahini dressing.",
    ingredients: "Quinoa, sweet potato, spinach, avocado, chickpeas, tahini",
    image:
      "https://plantbasednews.org/app/uploads/2020/09/vegan-buddha-bowl-recipe.jpg",
    steps: [
  ...
  },
  {
    ...
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWcW-E2-Ae8WQfqg1-7W56Pu-nhqvAGGuzcw&s",
    steps: [
...

  {
    ...
    prepTime: "30-60",
    description:
      "Kidney bean curry with rich onion-tomato base, naturally gluten-free.",
    ingredients: "Kidney beans, onions, tomatoes, ginger, garlic, garam masala",
    image:
      "https://www.indianhealthyrecipes.com/wp-content/uploads/2022/05/rajma-recipe-rajma-masala.jpg",
    steps: [
  ...
  },
  {
    ...
    prepTime: "over-60",
    description:
      "Light and refreshing quinoa salad with fresh vegetables and lemon dressing.",
    ingredients: "Quinoa, cucumber, tomatoes, lemon juice, olive oil, parsley",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTX5tfW8qDvdh9hWcxxNin7H0qgw17K4XuKpw&s",
    steps: [
  ...
  },
  {
    ...
    prepTime: "under-30",
    description:
      "Cooling dish made with yogurt and rice, tempered with curry leaves.",
    ingredients: "Rice, yogurt, curry leaves, green chilies, ginger, coriander",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJbmRPJgxXrNTdCKwm-i0sLR0OO8oL6aYCJA&s",
    steps: [
...
function displayRecipes(recipesToShow) {
  ...
  if (recipesToShow.length === 0) {
    recipesGrid.innerHTML =
      '<p style="text-align: center; grid-column: 1/-1; font-size: 1.2rem; color: var(--color-secondary);">No recipes found matching your criteria.</p>';
    return;
  }
...
function createRecipeCard(recipe) {
  ...
  card.innerHTML = `
    ...
    <div class="recipe-content">
      ...
      <p class="recipe-ingredients"><strong>Ingredients:</strong> ${
        recipe.ingredients
      }</p>
    </div>
  `;
...
function applyFilters(searchTerm = "") {
  ...
  filteredRecipes = recipes.filter((recipe) => {
    ...
    const matchesPrepTime =
      prepTimeFilter === "all" || recipe.prepTime === prepTimeFilter;
